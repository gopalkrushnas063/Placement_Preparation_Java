package com.example.employee_springboot_crud.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MyErrorDetails> DepartmentExceptionHandler(DepartmentException exp,WebRequest req){
